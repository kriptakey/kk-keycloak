...
class _LoginPageState extends State<LoginPage> {
  ...
  _serviceConfiguration = const AuthorizationServiceConfiguration(
    authorizationEndpoint:
        'https://raihan-keycloak.com/realms/KKI-Batam/protocol/openid-connect/auth',
    tokenEndpoint:
        'https://raihan-keycloak.com/realms/KKI-Batam/protocol/openid-connect/token',
    endSessionEndpoint:
        'https://raihan-keycloak.com/realms/KKI-Batam/protocol/openid-connect/logout',
  );
